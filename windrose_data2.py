...
output_file = 'windrose_data2.csv'

# Dictionary to store wind speeds per direction range
direction_ranges = {'N': [0, 0, 0, 0, 0, 0, 0, 0, 0],
                    'S': [0, 0, 0, 0, 0, 0, 0, 0, 0],
                    'E': [0, 0, 0, 0, 0, 0, 0, 0, 0],
                    'W': [0, 0, 0, 0, 0, 0, 0, 0, 0]}
        ...
        if wind_data_index != -1:
            ...
            if wind_direction.isdigit():
                ...
                if wind_speed < 2:
                    ...
                    direction_ranges[direction][5] += 1
                elif 12 <= wind_speed < 14:
                    direction_ranges[direction][6] += 1
                elif 14 <= wind_speed < 16:
                    direction_ranges[direction][7] += 1
                else:
                    direction_ranges[direction][8] += 1

# Open output file to write wind speeds per direction range
with open(output_file, 'w', newline='') as outfile:
    writer = csv.writer(outfile)
    writer.writerow(['direction', '0-2', '2-4', '4-6', '6-8', '8-10', '10-12', '12-14', '14-16', '16+'])
